...
subdirs_src_HiggsAnalysis_CombinedLimit := src_HiggsAnalysis_CombinedLimit_data src_HiggsAnalysis_CombinedLimit_test src_HiggsAnalysis_CombinedLimit_scripts src_HiggsAnalysis_CombinedLimit_macros src_HiggsAnalysis_CombinedLimit_python src_HiggsAnalysis_CombinedLimit_bin src_HiggsAnalysis_CombinedLimit_src
...
subdirs_src_CombineHarvester_CombineTools := src_CombineHarvester_CombineTools_scripts src_CombineHarvester_CombineTools_macros src_CombineHarvester_CombineTools_python src_CombineHarvester_CombineTools_input src_CombineHarvester_CombineTools_bin src_CombineHarvester_CombineTools_src
ALL_SUBSYSTEMS+=Test
subdirs_src_Test = 
ALL_PACKAGES += auxiliaries/pruning
subdirs_src_auxiliaries_pruning := 
...
ALL_PACKAGES += auxiliaries/datacards
subdirs_src_auxiliaries_datacards := src_auxiliaries_datacards_sm
...
ifeq ($(strip $(DataCard_Creation)),)
DataCard_Creation := self/src/CombineHarvester/CombineTools/bin
DataCard_Creation_files := $(patsubst src/CombineHarvester/CombineTools/bin/%,%,$(foreach file,DataCard_Creation.cpp,$(eval xfile:=$(wildcard src/CombineHarvester/CombineTools/bin/$(file)))$(if $(xfile),$(xfile),$(warning No such file exists: src/CombineHarvester/CombineTools/bin/$(file). Please fix src/CombineHarvester/CombineTools/bin/BuildFile.))))
DataCard_Creation_BuildFile    := $(WORKINGDIR)/cache/bf/src/CombineHarvester/CombineTools/bin/BuildFile
DataCard_Creation_LOC_USE := self  root rootmath roofit roostats histfactory libxml2 vdt python boost_program_options boost_filesystem boost_python boost_regex rootpy CombineHarvester/CombineTools
DataCard_Creation_PACKAGE := self/src/CombineHarvester/CombineTools/bin
ALL_PRODS += DataCard_Creation
DataCard_Creation_INIT_FUNC        += $$(eval $$(call Binary,DataCard_Creation,src/CombineHarvester/CombineTools/bin,src_CombineHarvester_CombineTools_bin,$(SCRAMSTORENAME_BIN),,$(SCRAMSTORENAME_BIN),bin,$(SCRAMSTORENAME_LOGS)))
DataCard_Creation_CLASS := BINARY
else
$(eval $(call MultipleWarningMsg,DataCard_Creation,src/CombineHarvester/CombineTools/bin))
endif
ifeq ($(strip $(PostFitShapes)),)
PostFitShapes := self/src/CombineHarvester/CombineTools/bin
PostFitShapes_files := $(patsubst src/CombineHarvester/CombineTools/bin/%,%,$(foreach file,PostFitShapes.cpp,$(eval xfile:=$(wildcard src/CombineHarvester/CombineTools/bin/$(file)))$(if $(xfile),$(xfile),$(warning No such file exists: src/CombineHarvester/CombineTools/bin/$(file). Please fix src/CombineHarvester/CombineTools/bin/BuildFile.))))
PostFitShapes_BuildFile    := $(WORKINGDIR)/cache/bf/src/CombineHarvester/CombineTools/bin/BuildFile
PostFitShapes_LOC_USE := self  root rootmath roofit roostats histfactory libxml2 vdt python boost_program_options boost_filesystem boost_python boost_regex rootpy CombineHarvester/CombineTools
PostFitShapes_PACKAGE := self/src/CombineHarvester/CombineTools/bin
ALL_PRODS += PostFitShapes
PostFitShapes_INIT_FUNC        += $$(eval $$(call Binary,PostFitShapes,src/CombineHarvester/CombineTools/bin,src_CombineHarvester_CombineTools_bin,$(SCRAMSTORENAME_BIN),,$(SCRAMSTORENAME_BIN),bin,$(SCRAMSTORENAME_LOGS)))
PostFitShapes_CLASS := BINARY
else
$(eval $(call MultipleWarningMsg,PostFitShapes,src/CombineHarvester/CombineTools/bin))
endif
...
ifeq ($(strip $(MyDataCard)),)
MyDataCard := self/src/CombineHarvester/CombineTools/bin
MyDataCard_files := $(patsubst src/CombineHarvester/CombineTools/bin/%,%,$(foreach file,MyDataCard.cpp,$(eval xfile:=$(wildcard src/CombineHarvester/CombineTools/bin/$(file)))$(if $(xfile),$(xfile),$(warning No such file exists: src/CombineHarvester/CombineTools/bin/$(file). Please fix src/CombineHarvester/CombineTools/bin/BuildFile.))))
MyDataCard_BuildFile    := $(WORKINGDIR)/cache/bf/src/CombineHarvester/CombineTools/bin/BuildFile
MyDataCard_LOC_USE := self  root rootmath roofit roostats histfactory libxml2 vdt python boost_program_options boost_filesystem boost_python boost_regex rootpy CombineHarvester/CombineTools
MyDataCard_PACKAGE := self/src/CombineHarvester/CombineTools/bin
ALL_PRODS += MyDataCard
MyDataCard_INIT_FUNC        += $$(eval $$(call Binary,MyDataCard,src/CombineHarvester/CombineTools/bin,src_CombineHarvester_CombineTools_bin,$(SCRAMSTORENAME_BIN),,$(SCRAMSTORENAME_BIN),bin,$(SCRAMSTORENAME_LOGS)))
MyDataCard_CLASS := BINARY
else
$(eval $(call MultipleWarningMsg,MyDataCard,src/CombineHarvester/CombineTools/bin))
endif
